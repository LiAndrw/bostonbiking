...
mapboxgl.accessToken = 'pk.eyJ1IjoibGlhbmRydyIsImEiOiJjbTdlcmt6ZmcwaHhtMm5vY3IxMndxaGdsIn0.2JI-pyVItpc1qFCAQWY4CQ';
...
map.on('load', async () => { 
  ...
  map.addLayer({
    ...
    type: 'line',
    source: 'boston_route',
    paint: { 'line-color': 'crimson', 'line-width': 3, 'line-opacity': 0.8 }
  });
  ...
  map.addLayer({
    ...
    paint: { 'line-color': 'purple', 'line-width': 3, 'line-opacity': 0.8 }
  });
